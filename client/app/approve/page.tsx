      ...
      <div className="space-y-8">
        ...
        <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 bg-zinc-900/50 backdrop-blur-sm space-y-4">
          ...
          <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700">
            <p className="text-sm text-zinc-300">
              ...
              For security, never share this code with others.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            className="w-full h-11 bg-red-500 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            {isProcessing.deny ? (
              <>
                <Spinner className="w-4 h-4" />
